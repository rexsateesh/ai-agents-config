...
> ```bash
> git clone https://github.com/rexsateesh/ai-agents-config.git ~/.claude/skills/gstack
> ```
...
```bash
git clone --single-branch --depth 1 https://github.com/rexsateesh/ai-agents-config.git .agents/skills/gstack
...
```bash
git clone --single-branch --depth 1 https://github.com/rexsateesh/ai-agents-config.git ~/gstack
